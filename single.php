...
while ( have_posts() ) : the_post(); $the_title = get_the_title(); $the_time = get_the_time('F j, Y'); $article = do_shortcode(wpautop(get_the_content())); $the_author = get_the_author(); $permalink = get_permalink(); $permalink_encoded = urlencode($permalink); $tags= get_the_tags(); endwhile;
